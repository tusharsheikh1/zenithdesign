...
const BottomCTA = () => {
  return (
    <section className="py-12 md:py-24 px-4 lg:px-8 bg-slate-50 dark:bg-slate-950 overflow-hidden">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="relative rounded-[2rem] md:rounded-[3.5rem] overflow-hidden bg-slate-900 isolate shadow-2xl shadow-indigo-500/20 ring-1 ring-white/10 transform transition-transform hover:scale-[1.01] duration-500">
          ...
          {/* 1. Animated Background Mesh (Optimized for Mobile) */}
          ...
          <div className="relative z-10 px-6 py-16 md:px-12 md:py-24 text-center flex flex-col items-center">
            ...
            <div className="w-full max-w-md flex flex-col sm:flex-row items-center justify-center gap-4 md:gap-6">
              ...
              {/* Primary: Call Button (Full width on mobile) */}
              <button className="group relative w-full sm:w-auto px-8 py-4 md:py-5 bg-white text-slate-950 rounded-xl md:rounded-2xl font-bold text-base md:text-lg flex items-center justify-center gap-3 transition-all duration-300 hover:scale-[1.02] shadow-[0_0_20px_-5px_rgba(255,255,255,0.3)]">
              ...
              {/* Secondary: Message Button (Full width on mobile) */}
              <button className="group w-full sm:w-auto px-8 py-4 md:py-5 bg-white/5 border border-white/10 hover:bg-white/10 text-white rounded-xl md:rounded-2xl font-bold text-base md:text-lg flex items-center justify-center gap-3 backdrop-blur-md transition-all duration-300 hover:scale-[1.02]">
